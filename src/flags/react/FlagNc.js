...
const FlagNc = props => (
  <svg xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 900 450" {...props}>
    <path fill="#009543" d="M0 0h900v450H0z" />
    <path fill="#ed4135" d="M0 0h900v300H0z" />
    <path fill="#0035ad" d="M0 0h900v150H0z" />
    <circle stroke="#000" strokeWidth={5} fill="#fae600" cx={300} cy={225} r={147.48} />
    <path stroke="#000" strokeWidth={6} d="M275 247h50m-50-37h50M300 78v252" />
    ...
    <g id="s918ee8f2">
      <path d="M265.5 163s3.914 11.23 4.5 22.5c.935 17.997 18.18 18.5 30 18.5v-10c-8.859 0-16.553-1.317-23-14.5-3.18-6.503-11.5-16.5-11.5-16.5zM265 308s6.296-7.765 13.662-25.975C282.505 272.525 291.612 267 300 267v-14c-19.028 0-28.15 7.055-29.113 17.363C268.91 291.541 265 308 265 308z" />
    </g>
    <use xlinkHref="#s918ee8f2" transform="matrix(-1 0 0 1 600 0)" />
  </svg>
);
