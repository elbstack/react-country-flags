...
const FlagAr = props => (
  <svg xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 800 500" {...props}>
    ...
    <g id="se045e878">
      ...
      />
      <use xlinkHref="#sb1b1fe44" transform="rotate(22.5 400 250)" />
      <use xlinkHref="#sb1b1fe44" transform="rotate(45 400 250)" />
      <use xlinkHref="#sb1b1fe44" transform="rotate(67.5 400 250)" />
      <path
        id="s5bbab83e"
        fill="#85340a"
      ...
      />
      <use xlinkHref="#s5bbab83e" transform="rotate(22.5 400 250)" />
      <use xlinkHref="#s5bbab83e" transform="rotate(45 400 250)" />
      <use xlinkHref="#s5bbab83e" transform="rotate(67.5 400 250)" />
    </g>
    <use xlinkHref="#se045e878" transform="rotate(90 400 250)" />
    <use xlinkHref="#se045e878" transform="rotate(180 400 250)" />
    <use xlinkHref="#se045e878" transform="rotate(270 400 250)" />
    ...
    />
    <use xlinkHref="#s18c45f93" transform="matrix(-1 0 0 1 800.25 0)" />
    <use xlinkHref="#s57ca51f2" transform="matrix(-1 0 0 1 800.25 0)" />
    <use xlinkHref="#s9ec37fa3" transform="translate(18.862)" />
    <use xlinkHref="#s93352330" transform="matrix(-1 0 0 1 800.25 0)" />
    <path
    ...
    />
    <path
      d="M393.75 262.72c-.248.003-.519.005-.813.031 4.488.428 2.331 3 7.032 3h.03c4.702 0 2.575-2.572 7.063-3-4.7-.426-3.214 2.344-7.062 2.344h-.031c-3.608 0-2.496-2.421-6.22-2.375zM403.85 269.66a3.848 3.848 0 0 0-3.846-3.846 3.848 3.848 0 0 0-3.847 3.846 3.955 3.955 0 0 1 3.847-3.04 3.952 3.952 0 0 1 3.846 3.04z"
      fill="#85340a"
    />
    <path
      id="s57ca51f2"
    ...
    />
    <use xlinkHref="#saf3f238d" transform="translate(-19.181)" />
    <circle id="s9ec37fa3" cy={246.15} cx={390.54} r={1.923} fill="#85340a" />
    <path
      id="s93352330"
      fill="#85340a"
