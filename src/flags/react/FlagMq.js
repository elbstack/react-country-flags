...
const FlagMq = props => (
  <svg xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 750 500" {...props}>
    <path fill="#21428e" d="M0 0h750v500H0z" />
    <path d="M375 0v500M0 250h750" stroke="#fff" strokeWidth={72.5} />
    <path
      id="s2c12afe0"
      ...
      fill="#fff"
    />
    <use xlinkHref="#s2c12afe0" x={411.25} />
    <use xlinkHref="#s2c12afe0" y={286.25} />
    <use xlinkHref="#s2c12afe0" x={411.25} y={286.25} />
  </svg>
);
